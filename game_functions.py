...
def ship_hit(ai_settings, stats, screen, ship, aliens, bullets):
    """Respond to thip being hit by alien."""
...
def create_fleet(ai_settings, screen, ship, aliens):
    ...
    # Spacing between each alien isequal to one alien width.
    alien = Alien(ai_settings, screen)
...
def update_aliens(ai_settings, stats, screen, ship, aliens, bullets):
    """Check if the fleet is at an edge, an then update the position of all aliens in the fleet."""
    ...
    # Look for aliens hitting the bottom ofthe screen.
